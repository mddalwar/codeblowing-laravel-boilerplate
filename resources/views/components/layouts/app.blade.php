  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="{{ route('home') }}" class="nav-link" target="_blank">See Website</a>
        </li>
      </ul>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#">
          <img src="http://127.0.0.1:8000/assets/img/user2-160x160.jpg" class="img-circle elevation-2 img-size-32" alt="User Image">
          </a>
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="{{ route('home') }}" class="brand-link">
        <span class="brand-text font-weight-bold">{{ env('APP_LOGO') }}</span>
      </a>
